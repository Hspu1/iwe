...
Revision ID: 9bfc4a42542a
Revises:
Create Date: 2026-07-27 14:29:45.046218
...
def upgrade() -> None:
    ...
    op.create_index('idx_orders_user_active', 'orders', ['user_id'], unique=False, postgresql_where=sa.text('status IN (3, 4)'))
...
def downgrade() -> None:
    ...
    op.drop_index('idx_orders_user_active', table_name='orders', postgresql_where=sa.text('status IN (3, 4)'))
